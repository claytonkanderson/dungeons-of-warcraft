"""MPQ huffman byte-weight tables (from StormLib huff.cpp, data only).

Index = compression data type 0-8 (sparse, binary, text, general,
adpcm4, adpcm6, stereo3, stereo4, stereo5). 256 weights per table.
"""
