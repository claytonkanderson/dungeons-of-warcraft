...
CURRENT LIMITATIONS
  ...
  - All twenty dungeons on the ladder are built, Ragefire Chasm to Upper
    Blackrock Spire, with Scarlet Monastery as four wings and Dire Maul
    as three, and the classic raids sit above them: Zul'Gurub, the Ruins
    of Ahn'Qiraj, Molten Core, Onyxia's Lair, Blackwing Lair and the
    Temple of Ahn'Qiraj. Some creatures have no model in the Anniversary client and
    a few event-summoned bosses have no spawn; those stand out in play.
